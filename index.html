            ...
            <div class="primary col-lg-8 col-12">
                <section class="about section">
                    <div class="section-inner shadow-sm rounded">
                        ...
                        <div class="content">
                            <p>Soy estudiante de Ingenieria en Sistemas de Información de la Universidad Tecnológica Nacional - Facultad Regional Tucumán en San Miguel de Tucumán. 
                                Me gusta programar y aprender sobre nuevas tecnologías. Disfruto trabajar con personas experimentadas y aprender de ellas, además de ser autodidacta y 
               ...
               <section class="latest section">
                    <div class="section-inner shadow-sm rounded">
                        ...
                        <div class="content">    
                            ...
                            <div class="item featured text-center">
                                ...
                                <h3 class="title mb-3"><a href="http://patronato.herokuapp.com/" target="_blank">Patronato - Sistema de Gestión de Asistidos</a></h3>
                                    
                                <div class="desc text-start">                                    
                                    <p>Sistema desarrollado en Laravel durante una pasantía en la Dirección de Patronato de Internos y Liberados. 
                                        En el se pueden gestionar a los asistidos por la repartición, almacenando la información de los mismos
                                        asi como de su grupo familiar y su situación de salud. Se puede gestionar distintos tipos de usuarios
                                        entre ellos personal de mesa de entrada, profesionales, directores, etc.
                                        </p>
                                    <p>Usuario:dyoussef Contraseña:123456</p>
                                </div><!--//desc-->         
                            ...
                            <div class="item row">
                                ...
                                <div class="desc col-md-8 col-12">
                                    ...
                                    <p class="mb-2">Sistema desarrollado en Laravel, con el que se puede generar un archivo .csv 
                                        ...
                                        Se debe cargar un archivo Excel (.xls) con los datos de los alumnos y el sistema generará automaticamente el archivo .csv</p>
                            ...
                            <div class="item row">
                                ...
                                <div class="desc col-md-8 col-12">
                                    <h3 class="title"><a href="https://la-siciliana-simulacion.herokuapp.com/" target="_blank">Simulación La Siciliana - Simulador de fábrica de pastas</a></h3>
                                    <p class="mb-2">Sistema desarrollado en Php qie realiza una simulación de la producción de pastas para la empresa La Siciliana. 
                                        Se deben ingresar la produccion esperada y la cantidad de días, y el simulador determinará la cantidad de ingredientes 
                ...
                <section class="projects section">
                    <div class="section-inner shadow-sm rounded">
                        ...
                        <div class="content">
                            <div class="item">
                                <h3 class="title"><a href="https://github.com/Dyoussef95/latienda" target="_blank">La Tienda - Sistema de facturación y control de stock</a> <span class="badge badge-theme">En desarrollo</span></h3>
                                <p class="summary">Sistema en progreso desarrollado en Java, para una tienda de venta de Ropa.
                                    El sistema deberá poder realizar la facturación y el control del stock de la tienda.
                                </p>
                            ...
                            <div class="item">
                                <h3 class="title"><a href="https://github.com/Dyoussef95/Pascal" target="_blank">Resolución de ejercicios de programación en lenguaje Pascal</a></h3>
                                <p class="summary">Soluciones a ejercicios de programación realizados a estudiantes de distintas ingenierias.
                                </p>
                ...
                <section class="experience section">
                    <div class="section-inner shadow-sm rounded">
                        ...
                        <div class="content">
                            <div class="item">
                                <h3 class="title">Becario - <span class="place"><a href="http://www.frt.utn.edu.ar/">Universidad Tecnológica Nacional</a></span> <span class="year">(2018 - Present)</span></h3>
                                <p>Gestión y administración del Campus Vitual Moodle. Brindar soporte y dictar talleres para alumnos y docentes de la universidad</p>
                            </div><!--//item-->
                            <div class="item">
                                ...
                                <p>Gestión y administración de campus virtual Moodle, soporte tecnológico en general.</p>
                            </div><!--//item-->
                            <div class="item">
                                <h3 class="title">Pasante de Área de Sistemas - <span class="place"><a href="https://www.tucuman.gob.ar/organismos/patronato-de-internos-y-liberados">Patronato de Internos y Liberados</a></span> <span class="year">(2019 - 2020)</span></h3>
                                <p>Análisis, diseño y desarrollo de sistemas informáticos. Soporte técnico en general</p>
                            </div><!--//item-->
                            <div class="item">
                                <h3 class="title">Pasante de Soporte IT - <span class="place"><a href="http://estadistica.tucuman.gov.ar/">Dirección de Estadísticas</a></span> <span class="year">(2019 - 2020)</span></h3>
                                <p>Dar soporte en materia de hardware y software a los empleados de la repartición</p>
                            </div><!--//item-->
                            <div class="item">
                                <h3 class="title">Maestro particular de programación - <span class="place"><a href="https://github.com/Dyoussef95/Pascal">Autónomo</a></span> <span class="year">(2016 - 2019)</span></h3>
                                <p>Clases particulares de programación en Pascal a alumnos de ingeniería</p>
                            </div><!--//item--> 
            ...
            <div class="secondary col-lg-4 col-12">
                    ...
                    <div class="section-inner shadow-sm rounded">
                        ...
                        <div class="content">
                            <ul class="list-unstyled">
                                <li><i class="fas fa-map-marker-alt"></i><span class="sr-only">Location:</span>San Miguel de Tucumán, Tucumán, Argentina</li>
                ...
                <aside class="skills aside section">
                    <div class="section-inner shadow-sm rounded">
                        ...
                        <div class="content">
                            <p class="intro">
                                Me gustaría destacar mi perseverancia y creatividad a la hora de resolver problemas </p>
                            
                            <div class="skillset">
                               
                                <div class="item">
                                    <h3 class="level-title">php &amp; Laravel<span class="level-label" data-bs-toggle="tooltip" data-bs-placement="left" title="Tengo 2 años de experiencia desarrollando en Laravel en relación de dependencia, y un poco mas de manera freelance, aun me considero Jr. en esta tecnología."><i class="fas fa-info-circle"></i>Junior</span></h3>
                                ...
                                <div class="item">
                                    <h3 class="level-title">Moodle<span class="level-label" data-bs-toggle="tooltip" data-placement="left" title="La necesidad de trabajo me llevó a aprender esta poderosa herramienta educativa, luego de años de experiencia me considero un profesional en la matéria"><i class="fas fa-info-circle"></i>Pro</span></h3>
                                    <div class="level-bar progress">
                                ...
                                <div class="item">
                                    <h3 class="level-title">Autonomía<span class="level-label" data-bs-toggle="tooltip" data-placement="left" title="La gran mayoría de mis conocimientos fueron de manera autodidacta, internet es mi biblioteca y trato de exprimirla al máximo"><i class="fas fa-info-circle"></i>Expert</span></h3>
                                    <div class="level-bar progress">
                                ...
                                <div class="item">
                                    <h3 class="level-title">Ganas de aprender<span class="level-label" data-bs-toggle="tooltip" data-placement="left" title="Es lo que me motiva a trabajar en Sistemas, creo que uno nunca llega a ser totalmente experto en un área, por lo que siempre hay cosas nuevas para aprender"><i class="fas fa-info-circle"></i>Expert</span></h3>
                                    <div class="level-bar progress">
									    <div class="progress-bar level-bar-inner" role="progressbar" style="width: 100%" aria-valuenow="100"  aria-valuemin="0" aria-valuemax="100"></div>
									</div><!--//level-bar-->                                  
                                </div><!--//item-->
              ...
              <!--  </aside>//section-->
                ...
                <aside class="education aside section">
                    <div class="section-inner shadow-sm rounded">
                        ...
                        <div class="content">
                            <div class="item">                      
                                <h3 class="title"><i class="fas fa-graduation-cap"></i> Ingeniería en Sistemas de Información</h3>
                                <h4 class="university">Universidad Tecnológica Nacional <span class="year">(2015-Actual)</span></h4>
                            </div><!--//item-->
                            <div class="item">
                                <h3 class="title"><i class="fas fa-graduation-cap"></i> Diplomatura en Programación Web</h3>
